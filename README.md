...
- パートナー企業探しをもっと簡単に
  - 制作背景
    - 前職での経験で、印刷・紙加工の協力会社探しがなかなか難しく、時間がかかってしまう傾向が合ったので、もっと気軽に検索したりコミュニケーションがとれるアプリケーションがあればよかったなぁという思いから作成に至りました。
  - ペルソナ
...
### DEMO
  - トップページ→企業ページ
    https://gyazo.com/4dd8316fd7e79561e3152d08cb45c48e

  - あいまい検索→企業ページ
    https://gyazo.com/5a182d44e7b25d681cfb3b1ae1e623bf

  - 企業ページ→お問い合わせチャットルームへ
    https://gyazo.com/4f178d1f38149655e1a0146cb7834174

  - チャットルームでメッセージ送信
    https://gyazo.com/7d4143ca84d5b2f8f0a72fc484f7c74d

  - 画像付きメッセージ送信
    https://gyazo.com/fc03622eacdc7d9bfafeaf7c72015f3c
    https://gyazo.com/b7b399f076812fe3136582b88a7d8b1a

### 工夫した機能
  - キーワード検索を気軽にできるように曖昧検索を可能にし、ActiveHashで登録済みの項目に関しては選択して検索できるようにした。
  また、どのページからでも検索できるように、ヘッダーに検索フォームを設置した。
  - 問い合わせ機能をチャット形式にすることで、ブラウザ上である程度会話できるようにした。画像投稿もできるようにし、視覚的にも相談しやすくなるようにした。
  - Bootstrapを使用し、入力フォームやボタンをモダンな見た目になるようビューを調整
  - オリジナル企業ロゴを画像編集ツールで作成
